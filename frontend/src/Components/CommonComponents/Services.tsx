...
const Services: React.FC = () => {
    ...
    if (loading) {
        return (
            <div className="py-32 px-12 mb-16 text-center">
                <h2 className="text-4xl font-bold mb-20">Our Services</h2>
        ...
        <div className="py-32 px-12 mb-16">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                {services
                    ...
                    .map((service) => (
                        <div key={service._id} className="bg-white shadow-lg rounded-lg p-6">
